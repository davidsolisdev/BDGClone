...
function CardVisionMision({ icon, title, description }: CardVisionMisionProps) {
  return (
    <article
      className="w-[45%] h-[500px] flex flex-col flex-wrap justify-star items-start bg-[#f5f5f5] rounded-lg shadow-lg max-[905px]:w-[90%] max-[905px]:mt-7 max-[905px]:h-[400px] max-[905px]:text-sm max-[550px]:text-[0.83rem] max-[550px]:h-[470px]"
