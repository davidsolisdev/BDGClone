      ...
      <g>
        ...
        >
          <path
            ...
            transform="translate(383.865 31)"
            fill="none"
            stroke="#b71222"
            stroke-width="15"
          ...
          <path
            ...
            transform="translate(470.992 304.505)"
            fill="none"
            stroke="#b71222"
            stroke-width="15"
            stroke-linecap="round"
          ...
          ></path>
          <path
            d="M0 0h40.195c11.05 0 20-8.95 20-20l.001-24.681"
            style={{
              strokeWidth: 15,
              strokeLinecap: "round",
              strokeLinejoin: "round",
            ...
            transform="translate(410.795 381)"
            fill="none"
            stroke="#b71222"
            stroke-width="15"
            stroke-linecap="round"
          ...
          <path
            ...
            transform="translate(371.586 381)"
            fill="none"
            stroke="#b71222"
            stroke-width="15"
            stroke-linecap="round"
          ...
          <path
            ...
            transform="translate(71.007 192.599)"
            fill="none"
            stroke="#b71222"
            stroke-width="15"
            stroke-linecap="round"
          ...
          ></path>
          <path
            d="M0 0h22.8l.01-239.99-369.991-.01-.002 49.227"
            style={{
              strokeWidth: 15,
              strokeLinecap: "round",
              strokeLinejoin: "round",
            ...
            transform="translate(418.19 351)"
            fill="none"
            stroke="#b71222"
            stroke-width="15"
            stroke-linecap="round"
          ...
          ></path>
          <path
            d="M0 0h-68c-6.627 0-12 5.373-12 12v12h92V12C12 5.373 6.627 0 0 0Z"
            style={{
              strokeWidth: 15,
              strokeLinecap: "round",
              strokeLinejoin: "round",
          ...
          <path
            ...
            transform="translate(376.69 396.556)"
            fill="none"
            stroke="#b71222"
            stroke-width="15"
            stroke-linecap="round"
          ...
          <path
            ...
            transform="translate(259.078 266.556)"
            fill="none"
            stroke="#b71222"
            stroke-width="15"
            stroke-linecap="round"
