  ...
  return (
    <section className="w-[600px] absolute left-[100px] max-[945px]:left-[50px] animate__animated animate__backInUp">
      <div className="w-full flex flex-col">
        <span className="w-full text-5xl font-bold text-red-700">
          {textRed}
        </span>
        <span className="w-full text-5xl font-bold text-gray-500 mt-2">
          {textGray}
        </span>
        <span className="w-[30%] h-[10px] bg-red-700"></span>
      </div>
      <p className="text-xl mt-5 text-gray-500">{description}</p>
